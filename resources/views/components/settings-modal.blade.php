            ...
            <div class="flex gap-[20px]">
                <div class="">
                    <div class="relative w-[80px] h-[80px]">
                        <x-user-image :user="$user" :size="74"/>
                        <label for="avatar" class="absolute w-[74px] h-[74px] top-0 left-0 rounded-full">
                            <div class="absolute w-[74px] h-[74px] top-0 left-0 rounded-full bg-[rgba(0,0,0,0.4)] overflow-hidden flex items-end opacity-0 hover:opacity-100 transition-[0.4s] cursor-pointer">
