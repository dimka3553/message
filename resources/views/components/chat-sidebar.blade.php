...
<div class="fixed top-0 left-0 h-full w-full max-w-[400px] bg-[#ffffff] border-r-[#ddd] border-r-[1px] z-50 pb-[76px]">
    <div class="overflow-auto allchats">
        <div class="sticky top-0 left-0 w-full h-[60px] flex items-center gap-[16px] px-[16px] bg-white z-[51]">
            <svg class="createchat cursor-pointer" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g>
